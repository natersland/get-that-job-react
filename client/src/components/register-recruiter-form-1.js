...
function RegisterRecruiter1 (props) {
    
    const {companyName, setCompanyName , email, setEmail ,password, setPassword ,confirmPassword, setConfirmPassword} = props;
...
export default RegisterRecruiter1;